...
| What ships in v0.4, and why not v0.3? | [ROADMAP.md](ROADMAP.md) |
| What should I work on next? | [TASKS.md](TASKS.md) |
| What are we building toward? | [TARGET_ARCHITECTURE.md](TARGET_ARCHITECTURE.md) |
| Why does the canary and benchmark work exist? | [RESEARCH_PLAN.md](RESEARCH_PLAN.md) |
| How is a phase delivered and gated? | [IMPLEMENTATION_PLAN.md](IMPLEMENTATION_PLAN.md) |
| What must be true before release? | [PRODUCTION_READINESS.md](PRODUCTION_READINESS.md) |
| What actually works against real targets? | [COMPATIBILITY.md](COMPATIBILITY.md) |
| How is one test case specified? | [TEST_SCENARIO_PLAN.md](TEST_SCENARIO_PLAN.md) |
...
[TARGET_ARCHITECTURE.md](TARGET_ARCHITECTURE.md) describes the design being
